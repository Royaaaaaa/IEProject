...
[
	...
	{id:"mainbg", size:456, src:"/static/app01/game/images/game_bg_2_hd.jpg?"+Math.random()},
	{id:"bottom", size:50, src:"/static/app01/game/images/bottom.png?"+Math.random()},
	{id:"fish1", size:6, src:"static/app01/game/images/fish1.png?"+Math.random()},
	{id:"fish2", size:16, src:"static/app01/game/images/fish2.png?"+Math.random()},
	{id:"fish3", size:11, src:"static/app01/game/images/fish3.png?"+Math.random()},
	{id:"fish4", size:15, src:"static/app01/game/images/fish4.png?"+Math.random()},
	{id:"fish5", size:43, src:"static/app01/game/images/fish5.png?"+Math.random()},
	{id:"fish6", size:45, src:"static/app01/game/images/fish6.png?"+Math.random()},
	{id:"fish7", size:80, src:"static/app01/game/images/fish7.png?"+Math.random()},
	{id:"fish8", size:100, src:"static/app01/game/images/fish8.png?"+Math.random()},
	{id:"fish9", size:104, src:"static/app01/game/images/fish9.png?"+Math.random()},
	{id:"fish10", size:121, src:"static/app01/game/images/fish10.png?"+Math.random()},
	{id:"shark1", size:287, src:"static/app01/game/images/shark1.png?"+Math.random()},
	{id:"shark2", size:382, src:"static/app01/game/images/shark2.png?"+Math.random()},
	{id:"cannon1", size:11, src:"static/app01/game/images/cannon1.png?"+Math.random()},
	{id:"cannon2", size:11, src:"static/app01/game/images/cannon2.png?"+Math.random()},
	{id:"cannon3", size:11, src:"static/app01/game/images/cannon3.png?"+Math.random()},
	{id:"cannon4", size:13, src:"static/app01/game/images/cannon4.png?"+Math.random()},
	{id:"cannon5", size:13, src:"static/app01/game/images/cannon5.png?"+Math.random()},
	{id:"cannon6", size:15, src:"static/app01/game/images/cannon6.png?"+Math.random()},
	{id:"cannon7", size:17, src:"static/app01/game/images/cannon7.png?"+Math.random()},
	{id:"bullet", size:8, src:"static/app01/game/images/bullet.png?"+Math.random()},
	{id:"web", size:93, src:"static/app01/game/images/web.png?"+Math.random()},
	{id:"numBlack", size:1, src:"static/app01/game/images/number_black.png?"+Math.random()},
	{id:"coinAni1", size:19, src:"static/app01/game/images/coinAni1.png?"+Math.random()},
	{id:"coinAni2", size:22, src:"static/app01/game/images/coinAni2.png?"+Math.random()},
	{id:"coinText", size:16, src:"static/app01/game/images/coinText.png?"+Math.random()}
];
