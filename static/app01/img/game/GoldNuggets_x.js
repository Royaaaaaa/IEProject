...
cq[bc].src = dJ;
bc++;
var dH = "static/app01/img/game/" + G + "info.png";
cq[bc] = new Image();
cq[bc].src = dH;
bc++;
var gl = 40 * f;
...
var R = 0;
if (ac == ar) {
    var dk = "static/app01/img/game/" + G + "fli.png";
    A[m] = new Image();
    A[m].src = dk;
    J();
    m++;
    var dj = "static/app01/img/game/" + G + "flo.png";
    A[m] = new Image();
    A[m].src = dj;
    J();
    m++;
    var bP = "static/app01/img/game/" + G + "fng.png";
    A[m] = new Image();
    A[m].src = bP;
    J();
    m++;
    var bN = "static/app01/img/game/" + G + "fhi.png";
    A[m] = new Image();
    A[m].src = bN;
    J();
    m++;
}
var ds = "static/app01/img/game/" + G + "t.jpg";
A[m] = new Image();
A[m].src = ds;
J();
m++;
var bK = "static/app01/img/game/" + G + "ng.png";
A[m] = new Image();
A[m].src = bK;
J();
m++;
var bY = "static/app01/img/game/" + G + "hi.png";
A[m] = new Image();
A[m].src = bY;
J();
m++;
var bv = "static/app01/img/game/" + G + "submit.png";
A[m] = new Image();
A[m].src = bv;
J();
m++;
var dQ ="static/app01/img/game/" + G + "continue.png";
A[m] = new Image();
A[m].src = dQ;
J();
m++;
var ci ="static/app01/img/game/" + G + "l1a.jpg";
A[m] = new Image();
A[m].src = ci;
J();
m++;
var cc ="static/app01/img/game/" + G + "l1b.jpg";
A[m] = new Image();
A[m].src = cc;
J();
m++;
var cs ="static/app01/img/game/" + G + "l2a.jpg";
A[m] = new Image();
A[m].src = cs;
J();
m++;
var ct ="static/app01/img/game/" + G + "l2b.jpg";
A[m] = new Image();
A[m].src = ct;
J();
m++;
var cu ="static/app01/img/game/" + G + "l3a.jpg";
A[m] = new Image();
A[m].src = cu;
J();
m++;
var cy ="static/app01/img/game/" + G + "l3b.jpg";
A[m] = new Image();
A[m].src = cy;
J();
m++;
...
if (g == ae)
    cQ = ".gif";
var ej ="static/app01/img/game/" + G + "ba" + cQ;
A[m] = new Image();
A[m].src = ej;
J();
m++;
...
for (var i = 0; i < 17; i++) {
    if ((i >= 9) && (i <= 12))
        aE[i] ="static/app01/img/game/" + G + "s" + (i) + ".gif";
    else
        aE[i] ="static/app01/img/game/" + G + "s" + (i) + cQ;
    A[m + i] = new Image();
    A[m + i].src = aE[i];
    J();
}
...
if ((g != ae) && (g != be)) {
    document.write('<div style=\'position:absolute;top:150px;left:' + (r) + 'px;width:' + (r * 2) + 'px;height:' + (D) + 'px;background:none! important;visibility:visible;z-Index:10000;\'></div>');
    document.write('<div style=\'position:absolute;top:150px;left:' + ( - r * 2) + 'px;width:' + (r * 2) + 'px;height:' + (D) + 'px;background-Color:#ffffff;visibility:visible;z-Index:10000;\'></div>');
}
function fl() {
    location.href = '/';
};
