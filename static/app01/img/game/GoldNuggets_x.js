...
function ec() {
    ...
    if (as < 10)
        ...
        document.getElementById("en").innerHTML = "   Exit";
    else
...
function test() {
    ...
    var h = document.getElementById('header-featured').offsetHeight;
    var h1 = document.getElementById('all').offsetHeight;
    document.getElementById('copyright').style.marginTop= (ai+100) + "px"
    ed();
};
function fQ() {
    if ((g == af) && (eY))
